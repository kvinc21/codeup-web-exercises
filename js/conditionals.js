 ...
 */
var inputColor = prompt("Choose a color");
...
//Generate a random number between 0 and 6
 var luckyNumber = Math.floor(Math.random() * 6);
  ...
  alert("Your total price before the discount is " +  totalBill);
  alert("your lucky number is " + luckyNumber);
  alert("Price after the discount is " + calculateTotal(luckyNumber, totalBill))
...
if (answer) {
    ...
    if (isNaN(number)) {
        ...
        alert("100 + your number is " + "Number(n");
    }
